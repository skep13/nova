...
"kitchen": [
 "Rice","Pasta","Bread","Egg as food","Potato","Roasting","Frying","Boiling",
 "Steaming","Grilling","Baking","Seasoning","Stock (food)","Sauce","Soup","Salad",
 "Spice","Herb","Marination","Kitchen knife","Knife sharpening","Cutting board",
 "Food preservation","Canning","Pickling","Freezing","Leftovers","Meal preparation",
 "Cookware and bakeware","Oven","Microwave oven","Slow cooker","Pressure cooking",
 "Sourdough","Yeast","Gluten","Butter","Olive oil","Vinegar","Salt","Sugar",
 "Chocolate","Cheese","Yogurt","Stir frying","Braising","Poaching (cooking)",
],
"household": [
 "Heat pump","Boiler","Radiator (heating)","Thermostat","Air conditioning",
 "Ventilation (architecture)","Insulated glazing","Drain (plumbing)","Sink",
 "Flush toilet","Shower","Water heating","Fuse (electrical)","Circuit breaker",
 "Residual-current device","Light fixture","Incandescent light bulb","Paint",
 "Wallpaper","Tile","Grout","Sealant","Silicone","Screw","Nail (fastener)",
 "Drill","Hammer","Saw","Spirit level","Tape measure","Sandpaper","Varnish",
 "Rust","Limescale","Condensation","Mold","Damp (structural)","Woodworm",
 "Smoke detector","Carbon monoxide detector","Fire extinguisher","Washing machine",
 "Dishwasher","Refrigerator","Vacuum cleaner",
],
"garden": [
 "Tomato","Vegetable","Fruit","Potato","Herb","Pruning","Mulch","Fertilizer",
 "Weed","Pest control","Greenhouse","Lawn","Irrigation","Compost","Seedling",
 "Germination","Perennial plant","Annual plant","Bulb","Grafting","Hedge",
 "Soil pH","Crop rotation","Companion planting","Frost","Growing season",
],
"sport": [
 "Association football","Offside (association football)","Rugby football","Cricket",
 "Tennis","Basketball","Golf","Athletics (sport)","Marathon","Olympic Games",
 "Boxing","Martial arts","Snooker","Darts","Formula One","Cycling sport",
 "Sports injury","Warming up","Stretching","Physical therapy","Sportsmanship",
],
"everyday": [
 "Jet lag","Heat wave","Sunburn","Sunscreen","Static electricity","Hiccup",
 "Yawn","Sneeze","Blister","Bruise","Cramp","Dehydration","Hangover",
 "Motion sickness","Snoring","Nail biting","Dandruff","Body odor","Halitosis",
 "Common cold","Hay fever","Insect bite","Splinter","Papercut","Burn",
 "Time zone","Daylight saving time","Leap year","Public holiday","Queue area",
 "Tipping","Etiquette","Small talk","Handshake","Body language",
],
"selfwork": [
 "Impostor syndrome","Perfectionism (psychology)","Introversion and extraversion",
 "Self-control","Delayed gratification","Goal setting","Feedback",
 "Active listening","Conflict resolution","Apology","Boundary setting",
 "Self-care","Burnout","Rumination (psychology)","Overthinking","Comparison",
 "Envy","Regret","Nostalgia","Boredom","Curiosity","Awe","Humour","Play",
],
}
